 ...
 *         &lt;element name="Cd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max10Text" minOccurs="0"/>
 *         &lt;element name="Amt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="Inf" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class StructuredRegulatoryReporting3 {
	...
	public String toString() {
		return "StructuredRegulatoryReporting3 [tp=" + tp + ", dt=" + dt + ", ctry=" + ctry + ", cd=" + cd + ", amt="
				+ amt + ", inf=" + inf + "]";
	}

...
/**
 * <p>
 * Java class for ReferredDocumentInformation7 complex type.
 * 
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ReferredDocumentType4" minOccurs="0"/>
 *         &lt;element name="Nb" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="RltdDt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ISODate" minOccurs="0"/>
 *         &lt;element name="LineDtls" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}DocumentLineInformation1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReferredDocumentInformation7", propOrder = { "tp", "nb", "rltdDt", "lineDtls" })
public class ReferredDocumentInformation7 {
	 ...
	 * 
	 * @return possible object is {@link ReferredDocumentType4 }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link ReferredDocumentType4 }
	 * 
	 */
	...
	public String toString() {
		return "ReferredDocumentInformation7 [tp=" + tp + ", nb=" + nb + ", rltdDt=" + rltdDt + ", lineDtls=" + lineDtls
				+ "]";
	}

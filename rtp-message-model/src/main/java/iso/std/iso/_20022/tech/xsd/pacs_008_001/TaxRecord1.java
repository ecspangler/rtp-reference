 ...
 *       &lt;sequence>
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="Ctgy" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="CtgyDtls" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="DbtrSts" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="CertId" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="FrmsCd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="Prd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}TaxPeriod1" minOccurs="0"/>
 *         &lt;element name="TaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}TaxAmount1" minOccurs="0"/>
 *         &lt;element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max140Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TaxRecord1 {
	 ...
	 * 
	 * @return possible object is {@link TaxAmount1 }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link TaxAmount1 }
	 * 
	 */
	...
	public String toString() {
		return "TaxRecord1 [tp=" + tp + ", ctgy=" + ctgy + ", ctgyDtls=" + ctgyDtls + ", dbtrSts=" + dbtrSts
				+ ", certId=" + certId + ", frmsCd=" + frmsCd + ", prd=" + prd + ", taxAmt=" + taxAmt + ", addtlInf="
				+ addtlInf + "]";
	}

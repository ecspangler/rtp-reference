 ...
 *       &lt;sequence>
 *         &lt;element name="DbtCdtRptgInd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}RegulatoryReportingType1Code" minOccurs="0"/>
 *         &lt;element name="Authrty" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}RegulatoryAuthority2" minOccurs="0"/>
 *         &lt;element name="Dtls" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}StructuredRegulatoryReporting3" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RegulatoryReporting3 {
	 ...
	 * 
	 * @return possible object is {@link RegulatoryReportingType1Code }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link RegulatoryReportingType1Code }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link RegulatoryAuthority2 }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link RegulatoryAuthority2 }
	 * 
	 */
	...
	public String toString() {
		return "RegulatoryReporting3 [dbtCdtRptgInd=" + dbtCdtRptgInd + ", authrty=" + authrty + ", dtls=" + dtls + "]";
	}

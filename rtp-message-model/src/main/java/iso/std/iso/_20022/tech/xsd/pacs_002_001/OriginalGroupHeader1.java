...
/**
 * <p>
 * Java class for OriginalGroupHeader1 complex type.
 * 
 * <p>
...
@XmlType(name = "OriginalGroupHeader1", propOrder = { "orgnlMsgId", "orgnlMsgNmId", "orgnlCreDtTm", "orgnlNbOfTxs",
...
public class OriginalGroupHeader1 {
	 ...
	 * 
	 * @return possible object is {@link TransactionGroupStatus3Code }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link TransactionGroupStatus3Code }
	 * 
	 */
	 ...
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the nbOfTxsPerSts property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	public String toString() {
		return "OriginalGroupHeader1 [orgnlMsgId=" + orgnlMsgId + ", orgnlMsgNmId=" + orgnlMsgNmId + ", orgnlCreDtTm="
				+ orgnlCreDtTm + ", orgnlNbOfTxs=" + orgnlNbOfTxs + ", orgnlCtrlSum=" + orgnlCtrlSum + ", grpSts="
				+ grpSts + ", stsRsnInf=" + stsRsnInf + ", nbOfTxsPerSts=" + nbOfTxsPerSts + "]";
	}

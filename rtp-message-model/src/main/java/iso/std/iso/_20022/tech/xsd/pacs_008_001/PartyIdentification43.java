 ...
 *         &lt;element name="PstlAdr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}PostalAddress6" minOccurs="0"/>
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Party11Choice" minOccurs="0"/>
 *         &lt;element name="CtryOfRes" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}CountryCode" minOccurs="0"/>
 *         &lt;element name="CtctDtls" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ContactDetails2" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PartyIdentification43", propOrder = { "nm", "pstlAdr", "id", "ctryOfRes", "ctctDtls" })
public class PartyIdentification43 {
	 ...
	 * 
	 * @return possible object is {@link Party11Choice }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link Party11Choice }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link ContactDetails2 }
	 * 
	 */
	...
	public String toString() {
		return "PartyIdentification43 [nm=" + nm + ", pstlAdr=" + pstlAdr + ", id=" + id + ", ctryOfRes=" + ctryOfRes
				+ ", ctctDtls=" + ctctDtls + "]";
	}

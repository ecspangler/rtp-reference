 ...
 *       &lt;sequence>
 *         &lt;element name="Cdtr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}TaxParty1" minOccurs="0"/>
 *         &lt;element name="Dbtr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}TaxParty2" minOccurs="0"/>
 *         &lt;element name="UltmtDbtr" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}TaxParty2" minOccurs="0"/>
 *         &lt;element name="AdmstnZone" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="RefNb" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max140Text" minOccurs="0"/>
 *         &lt;element name="Mtd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
 *         &lt;element name="TtlTaxblBaseAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="TtlTaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="Dt" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}ISODate" minOccurs="0"/>
 *         &lt;element name="SeqNb" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Number" minOccurs="0"/>
 *         &lt;element name="Rcrd" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}TaxRecord1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TaxInformation4", propOrder = { "cdtr", "dbtr", "ultmtDbtr", "admstnZone", "refNb", "mtd",
...
public class TaxInformation4 {
	 ...
	 * 
	 * @return possible object is {@link TaxParty1 }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link TaxParty1 }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link TaxParty2 }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link TaxParty2 }
	 * 
	 */
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TaxRecord1 }
	 * 
	 * 
	 */
	...
	public String toString() {
		return "TaxInformation4 [cdtr=" + cdtr + ", dbtr=" + dbtr + ", ultmtDbtr=" + ultmtDbtr + ", admstnZone="

 ...
 *         &lt;element name="AdmstnZn" type="{urn:iso:std:iso:20022:tech:xsd:pacs.008.001.06}Max35Text" minOccurs="0"/>
...
public class TaxInformation3 {
	...
	public String toString() {
		return "TaxInformation3 [cdtr=" + cdtr + ", dbtr=" + dbtr + ", admstnZn=" + admstnZn + ", refNb=" + refNb
				+ ", mtd=" + mtd + ", ttlTaxblBaseAmt=" + ttlTaxblBaseAmt + ", ttlTaxAmt=" + ttlTaxAmt + ", dt=" + dt
				+ ", seqNb=" + seqNb + ", rcrd=" + rcrd + "]";
	}

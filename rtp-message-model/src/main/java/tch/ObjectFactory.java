...
public class ObjectFactory {
    ...
    private final static QName _Message_QNAME = new QName("urn:tch", "Message");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tch
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:tch", name = "Message")

...
public class DebitPayment implements Serializable {
	...
	public DebitPayment(Payment payment) {
		super();
		this.id = payment.getId();
		this.paymentId = payment.getPaymentId();
		this.senderRoutingNumber = payment.getSenderRoutingNumber();
		this.senderAccountNumber = payment.getSenderAccountNumber();
		this.senderFirstName = payment.getSenderFirstName();
		this.senderLastName = payment.getSenderLastName();
		this.amount = payment.getAmount();
		this.receiverFirstName = payment.getReceiverFirstName();
		this.receiverLastName = payment.getReceiverLastName();
		this.receiverEmail = payment.getReceiverEmail();
		this.receiverCellPhone = payment.getReceiverCellPhone();
		this.receiverAccountNumber = payment.getReceiverAccountNumber();
		this.status = payment.getStatus();
		this.messageStatusReportId = payment.getMessageStatusReportId();
	}

	public DebitPayment(Payment payment, MessageStatusReport messageStatusReport, String status) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DebitPayment other = (DebitPayment) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "DebitPayment [id=" + id + ", paymentId=" + paymentId + ", senderRoutingNumber=" + senderRoutingNumber
				...
				+ senderCellPhone + ", receiverFirstName=" + receiverFirstName + ", receiverLastName="
				+ receiverLastName + ", receiverEmail=" + receiverEmail + ", receiverCellPhone=" + receiverCellPhone

...
public class DebtorSendPaymentRouteBuilder extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("kafka:" + kafkaConsumerTopic + "?brokers=" + kafkaBootstrap + "&maxPollRecords=" + consumerMaxPollRecords
				...
				+ "&valueDeserializer=" + deserializerClass).routeId("FromKafka")
						.log("\n/// Payments to be sent to  RTP  >>> ${body}")
						.bean(PaymentTransformer.class, "toCreditTransferMessage")
						.log("Transformed to Credit Transfer Message >>> ${body}")
						.to("kafka:" + kafkaProducerTopic + "?serializerClass=" + serializerClass);
	}

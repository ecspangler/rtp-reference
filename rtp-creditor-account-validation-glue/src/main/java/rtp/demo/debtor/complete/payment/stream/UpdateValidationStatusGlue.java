...
public class UpdateValidationStatusGlue {
	...
	private void triggerAdhocTask(String key, String value) {
		...
		customerProxy.triggerAdhocTask(new Gson().fromJson(val[0],String.class),"{\"caseFile_accountValidationComplete\":" +
				"true, \"caseFile_isValidated\":"+payment.getIsValidated()+"}");
	}
